    ...
    >
      <View style={styles.contentContainer}>
        <View style={styles.modalBtns}>
          <Text style={styles.containerHeadline}>{t("settings")}</Text>
        ...
        <View>
          <View style={styles.row}>
            <View style={styles.rowText}>
              <Text style={styles.rowTextBig}>{t("hardMode")}</Text>
          ...
          <View style={styles.row}>
            <View style={styles.rowText}>
              <Text style={styles.rowTextBig}>{t("darkMode")}</Text>
              <Text style={styles.rowTextSmall}>
          ...
          <View style={styles.row}>
            <View style={styles.rowText}>
              <Text style={styles.rowTextBig}>{t("highContrastMode")}</Text>
              <Text style={styles.rowTextSmall}>
                {t("highContrastModeDescription")}
              </Text>
            </View>
            <Switch
          ...
          <View style={styles.row}>
            <View style={styles.rowText}>
              <Text style={styles.rowTextBig}>{t("language")}</Text>
            </View>
            <View style={{ gap: 40, flexDirection: "row" }}>
              <TouchableOpacity onPress={() => switchLanguage("en")}>
                <Text>English</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => switchLanguage("tr")}>
                <Text>Türkçe</Text>
              </TouchableOpacity>
            </View>
          </View>
